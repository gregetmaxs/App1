...
fun CategoryScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Kategori", color = Color.White) },
                navigationIcon = {
                ...
                items(categories) { cat ->
                    Card(
                        ...
                        Row(
                            ...
                            Text(cat.name, color = Color.White, fontWeight = FontWeight.SemiBold, modifier = Modifier.weight(1f))
        ...
        AlertDialog(
            ...
            text = {
                OutlinedTextField(
                    ...
                    colors = OutlinedTextFieldDefaults.colors(focusedBorderColor = TealPrimary, unfocusedBorderColor = Color(0xFF444466))
                )
            },
            confirmButton = {
                TextButton(onClick = {
                    if (newName.isNotBlank()) {
                        viewModel.create(newName, storeId)
                        newName = ""
                        showDialog = false
                    }
